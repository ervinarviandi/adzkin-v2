            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-sm text-left">
                  Adzkin, Sebuah aplikasi dzikir yang memandu penggunanya dalam
                  berzikir pagi atau sore hari berdasarkan waktu mereka saat
                  ini. semua data dalam aplikasi ini diambil menggunakan Public
                  API.
                  <br />
                </AccordionContent>
              </AccordionItem>
